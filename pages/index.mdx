...
- 112-1 Physical Design Automation
    - [Unit 1: Introduction](Course-Notes/112-1_PDA/pda_1.mdx)
    - [Unit 2: EDA Paradigms & Complexity](Course-Notes/112-1_PDA/pda_2.mdx)
    - [Unit 3: Partitioning](Course-Notes/112-1_PDA/pda_3.mdx)
- 112-1 Operating System
    - [L1: Recap](Course-Notes/112-1_OS/os_1.mdx)
    - [L2-1: Process & Scheduling](Course-Notes/112-1_OS/os_2_1.mdx)
    - [L2-2: Interrupt](Course-Notes/112-1_OS/os_2_2.mdx)
    - [L3: Memory Management](Course-Notes/112-1_OS/os_3.mdx)
- 112-1 Parallel Programming
    - [L1: Overview of Parallel and Distributed Programming](Course-Notes/112-1_PP/pp_1.mdx)
    - [L2: Introduction to Parallel Hardware and Software](Course-Notes/112-1_PP/pp_2.mdx)
    - [L3: Shared-Memory Programming with Pthreads (Part 1)](Course-Notes/112-1_PP/pp_3_1.mdx)
    - [L3: Shared-Memory Programming with Pthreads (Part 2)](Course-Notes/112-1_PP/pp_3_2.mdx)
    - [L4: Shared-Memory Programming with OpenMP (Part 1)](Course-Notes/112-1_PP/pp_4.mdx)
