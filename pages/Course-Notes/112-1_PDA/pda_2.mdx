...
![](https://hackmd.io/_uploads/r13ewwEeT.png)

**Algorithm:** a well-defined procedure transforming some input (高階電路) to a desired output (RTL code, Verilog) in **finite** computational resources in **time** and **space**.
