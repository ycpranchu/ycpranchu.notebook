...
<Callout type="info" emoji="ℹ">
Regarding performance, memory allocation inside kernel usually uses kmalloc(). (large regions of memory)
</Callout>
...
> Processes access the mm field in the process descriptor.
